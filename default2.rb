...
@recipes = ["core", "git", "railsapps", "setup", "readme", "gems", "email", "models", "controllers", "views", "routes", "init", "frontend", "saas", "testing", "prelaunch", "extras"]
@prefs = {}
@gems = ["draper", "sidekiq", "redis-rails"]
